...
async function AboutUs() {
    ...
    return (
        <main className="page-content">
            <PageBanner title="Về chúng tôi" bnrimage={bannerUrl || IMAGES.bnr1.src} />
            ...
            >
                <RealPatient data={testimonialData} />
            </section>
            ...
            <section className="content-inner">
                <div className="container">
                    <div className="row g-xl-4 align-items-center">
                        ...
                        <AboutAppointmentForm />
                    </div>
                </div>
            </section>

            <Schedule data={aboutConsultation} />

            <Clientswiper1 data={aboutInsurance} />
        </main>
    );
}
