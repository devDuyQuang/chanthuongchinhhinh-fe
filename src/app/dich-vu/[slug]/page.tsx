...
import SurgeryBlog from "../../(services)/service-detail/_components/SurgeryBlog";
import AccordionBlog from "../../(services)/service-detail/_components/AccordionBlog";
        ...
        <main className="page-content">
            ...
            <section className="content-inner service-single">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12 single-inner order-lg-1">
                            {category.image && (
