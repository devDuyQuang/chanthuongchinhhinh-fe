...
//     // mapping đúng: ưu tiên page riêng, fallback về site common
//     const rawMapIframe = contactInfo?.map_iframe || site?.map;
//     const primaryLocation = contactLocations?.items?.[0];

//     const mapIframe = rawMapIframe
//         ? rawMapIframe
//             .replace(/width="[^"]*"/i, 'width="100%"')
//             .replace(/height="[^"]*"/i, 'height="450"')
//             .replace(/style="[^"]*"/i, 'style="border:0;width:100%;height:450px;display:block;"')
//         : undefined;
