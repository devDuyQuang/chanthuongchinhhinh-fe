            ...
            <div className="row">
              <div className="col-lg-4 m-b30">
                <aside className="side-bar sticky-top">
                  ...
                  <div
                    className="widget widget_schedule bg-secondary text-white wow fadeInUp"
                    data-wow-delay="0.2s"
                    data-wow-duration="0.7s"
                  >
              ...
              <div className="col-lg-8 ps-xl-5 m-b30">
                <div className="section-head style-1 mb-30">
                  ...
                  <p
                    className="text-primary m-b20 fw-normal font-16 wow fadeInUp"
                    data-wow-delay="0.2s"
                    data-wow-duration="0.7s"
                  >
                    MBBS (Village Town), USA (Cardiac Surgery)
                  </p>
                  <p
                    className="fw-normal m-b0 wow fadeInUp"
                    data-wow-delay="0.3s"
                    data-wow-duration="0.7s"
                  >
                ...
                <Table
                  className="table table-striped table-striped-rounded m-b40 wow fadeInUp"
                  data-wow-delay="0.4s"
                  data-wow-duration="0.7s"
                >
                  <thead>
                ...
                <h3
                  className="font-20 m-b15 wow fadeInUp"
                  data-wow-delay="0.5s"
                  data-wow-duration="0.7s"
                >
                  Professional Skills
                ...
                <ul
                  className="list-check-circle list-light text-secondary fw-medium grid-2 m-b40 wow fadeInUp"
                  data-wow-delay="0.6s"
                  data-wow-duration="0.7s"
                >
                ...
                <div
                  className="form-wrapper style-1 wow fadeInUp"
                  data-wow-delay="0.7s"
                  data-wow-duration="0.7s"
                >
                  <div
                    className="form-body bg-primary background-blend-burn"
                    style={{ backgroundImage: `url(${IMAGES.bg2png})` }}
                  >
                    <div className="title-head">
                      <h2 className="form-title m-b0">
                        Make An <span>Appointment</span> Apply For Treatments
                      </h2>
                    </div>
                    <AppointForm />
                  </div>
