    ...
    return (
        <form ref={form} onSubmit={handleSubmit} method="post" id="comments_form" className="comment-form" noValidate>
            ...
            <p className="comment-form-comment">
                <textarea id="comments" placeholder="Nhập nội dung bình luận..." className="form-control4" name="comment"
                    cols={45} rows={3} required></textarea>
            </p>
            <p className="col-md-12 col-sm-12 col-xs-12 form-submit">
                <button id="submit" type="submit" className="submit btn btn-primary btn-lg filled">Gửi bình luận</button>
            </p>
        </form>
    )
}
