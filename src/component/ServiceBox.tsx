...
//     fetch(`/api/svg-proxy?url=${encodeURIComponent(src)}`)
...
//     <>
//       <style jsx global>{`
//         .icon-bx-wraper.style-3 .icon-cell svg {
//           width: 100%;
//           height: 100%;
...
//         .icon-bx-wraper.style-3.active .icon-cell svg,
//         .icon-bx-wraper.style-3:hover .icon-cell svg {
//           color: #fff;
//         }
...
//         .icon-bx-wraper.style-3.active .icon-bg svg,
//         .icon-bx-wraper.style-3:hover .icon-bg svg {
//           color: #fff;
//         }
//       `}</style>
...
//                     <InlineSvgIcon src={item.icon} fallbackSvg={item.svg1} />
//                   </span>
//                 </div>

//                 <span className="icon-bg">
//                   <InlineSvgIcon src={item.icon} fallbackSvg={item.svg2} />
//                 </span>
